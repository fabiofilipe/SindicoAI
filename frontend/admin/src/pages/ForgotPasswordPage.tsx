...
const ForgotPasswordPage = () => {
    ...
    return (
        <div className="min-h-screen flex items-center justify-center bg-gradient-warm p-4">
            {/* Decorative borders - signature lobby style */}
            ...
            <Card variant="signature" className="w-full max-w-md relative z-10 !p-8">
                {!emailSent ? (
                    <>
                        <div className="text-center mb-8">
                            <div className="flex justify-center mb-6">
                                <div className="w-16 h-16 bg-brass rounded-2xl flex items-center justify-center shadow-brass">
                                    <Mail className="w-8 h-8 text-cream" strokeWidth={1.5} />
                                </div>
                            </div>
                        ...
                        <form onSubmit={handleSubmit} className="space-y-6">
                            ...
                            <div className="text-center mt-4">
                                <Link
                                    to="/login"
                                    className="text-brass hover:text-brass-light transition-colors inline-flex items-center gap-2 font-medium"
                                >
                    ...
                    <div className="text-center">
                        <div className="flex justify-center mb-6">
                            <div className="w-16 h-16 bg-garden/20 rounded-2xl flex items-center justify-center border border-garden/30">
